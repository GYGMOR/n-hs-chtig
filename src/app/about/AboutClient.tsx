...
export default function AboutClient({ cmsImageMap }: AboutClientProps) {
  return (
            ...
            <div className="lg:col-span-6 relative flex justify-center">
              ...
              >
                <div className="w-[240px] h-[240px] sm:w-[320px] sm:h-[320px] md:w-[420px] md:h-[420px] lg:w-[480px] lg:h-[480px] rounded-full overflow-hidden border-[8px] md:border-[16px] border-white shadow-[0_32px_64px_-16px_rgba(0,0,0,0.2)] relative z-10 group">
                  <CMSImage
                    src={cmsImageMap["about_founder"]?.url}
                    alt={cmsImageMap["about_founder"]?.alt || "Jlonka Dubach"}
                    className="w-full h-full object-cover transition-all duration-1000 group-hover:scale-105"
                    label={cmsImageMap["about_founder"]?.label || "Gründerin Bild"}
                  />
                </div>
            ...
            <div className="lg:col-span-7">
              <div className="grid grid-cols-2 gap-4 md:gap-6 lg:gap-8">
                <div className="aspect-[3/4] rounded-[32px] md:rounded-[48px] overflow-hidden glass-premium translate-y-6 md:translate-y-12">
                  <CMSImage
                    src={cmsImageMap["about_workshop_1"]?.url}
                    alt={cmsImageMap["about_workshop_1"]?.alt || "Workshop 1"}
                    className="w-full h-full object-cover"
                    label={cmsImageMap["about_workshop_1"]?.label || "Werkstatt Bild 1"}
                  />
                </div>
                <div className="aspect-[3/4] rounded-[32px] md:rounded-[48px] overflow-hidden glass-premium">
                  <CMSImage
                    src={cmsImageMap["about_workshop_2"]?.url}
                    alt={cmsImageMap["about_workshop_2"]?.alt || "Workshop 2"}
                    className="w-full h-full object-cover"
                    label={cmsImageMap["about_workshop_2"]?.label || "Werkstatt Bild 2"}
                  />
                </div>
              </div>
            </div>
